...
const translations = {
  ru: {
    ...
    subtitle: "Надежная защита для дома и бизнеса",
    callBtn: "Позвонить",
    catalog: "Каталог",
    ...
    specOp: "Порошковый, с кронштейном",
    specOpLarge: "Порошковый",
    descOp: "Универсальный огнетушитель. Подходит для тушения твердых веществ, горючих жидкостей и электропроводки. Самый популярный выбор для дома и авто.",
    ou2Title: "ОУ-2", ou3Title: "ОУ-3", ou5Title: "ОУ-5", ou10Title: "ОУ-10",
    specOu: "Углекислотный",
    ...
    specHose50_10: "D: 50 | 1.0 бар | 20м | ГР-50, РС-50 (с навязкой)",
    ...
    heroText: "Огнетушители, рукава и комплектующие"
  },
  uz: {
    shortTitle: "NTA",
    mainTitle: "New Tex Alliance",
    subtitle: "Uy va biznes uchun ishonchli himoya",
    ...
    specOp: "Kukunli, kronshteyn bilan birga",
    specOpLarge: "Kukunli",
    descOp: "Universal o't o'chirgich. Qattiq moddalar, yonuvchi suyuqliklar va elektr simlarini o'chirish uchun javob beradi. Uy va avtomobil uchun eng mashhur tanlov.",
    ou2Title: "OU-2", ou3Title: "OU-3", ou5Title: "OU-5", ou10Title: "OU-10",
    specOu: "Karbonat angidridli",
    ...
    heroText: "O‘t o‘chirgichlar, shlanglar va ehtiyot qismlar"
  },
  zh: {
    shortTitle: "NTA",
    mainTitle: "New Tex Alliance",
    subtitle: "为您的家庭和企业提供可靠的保护",
    callBtn: "呼叫",
    catalog: "产品目录",
    scrollHint: "向下滚动",
    ...
    specOp: "干粉型，带安装支架",
    specOpLarge: "干粉型",
    descOp: "通用型灭火器。适用于扑灭固体、可燃液体和电气设备的火灾。家庭和汽车的最受欢迎选择。",
    ou2Title: "OU-2", ou3Title: "OU-3", ou5Title: "OU-5", ou10Title: "OU-10",
    specOu: "二氧化碳型",
